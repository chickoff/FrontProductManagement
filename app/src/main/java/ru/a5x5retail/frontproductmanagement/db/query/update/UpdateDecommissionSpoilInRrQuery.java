...
public class UpdateDecommissionSpoilInRrQuery extends CallableQuery {
    String checkingListHeadGuid;

    public UpdateDecommissionSpoilInRrQuery(Connection connection, String checkingListHeadGuid) {
        super(connection);
