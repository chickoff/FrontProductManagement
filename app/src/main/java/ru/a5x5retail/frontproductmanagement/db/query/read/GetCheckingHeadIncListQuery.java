...
public class GetCheckingHeadIncListQuery extends CallableQuery<CheckingListHead> {

    private int typeDocId;
    private String imei;
    private List<CheckingListHead> headList;
    public GetCheckingHeadIncListQuery(Connection connection, String imei, Integer typeDocId) {
        super(connection);
    ...
    protected void SetQuery() {
        setSqlString("{? = call V_StoreTSD.dbo.CheckingListIncGetHead(?,?)}");
    }
