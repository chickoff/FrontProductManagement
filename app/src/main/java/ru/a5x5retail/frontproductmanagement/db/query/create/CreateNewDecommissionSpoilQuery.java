...
public class CreateNewDecommissionSpoilQuery extends CallableQuery {

    String  imei,relationGuid,headGuid;


    public CreateNewDecommissionSpoilQuery(Connection connection, String relationGuid, String imei) {
        super(connection);
        this.imei = imei;
    ...
    protected void SetQuery() {
        setSqlString("{call V_StoreTSD.dbo.DecommissionSpoilHeadADD(?, ?, ?)}");
    }
