...
import ru.a5x5retail.frontproductmanagement.сheckinglist.db.converters.GetSKUContextConverter;
...
public class CheckingListGoodsGetSKUInfo implements IQuery {
    ...
    public CheckingListGoodsGetSKUInfo(String barcode) {
